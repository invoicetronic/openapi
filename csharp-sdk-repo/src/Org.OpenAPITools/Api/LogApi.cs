...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class LogApi : ILogApi
    {
        ...
        /// <returns></returns>
        public LogApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public LogApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<List<Event>> localVarResponse = InvoiceV1LogGetWithHttpInfo(page, pageSize);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Event&gt;</returns>
        public Org.OpenAPITools.Client.ApiResponse<List<Event>> InvoiceV1LogGetWithHttpInfo(int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<List<Event>> localVarResponse = await InvoiceV1LogGetWithHttpInfoAsync(page, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Event&gt;)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<List<Event>>> InvoiceV1LogGetWithHttpInfoAsync(int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Event> localVarResponse = InvoiceV1LogIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Event</returns>
        public Org.OpenAPITools.Client.ApiResponse<Event> InvoiceV1LogIdGetWithHttpInfo(int id, int operationIndex = 0)
        {
            Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = new Org.OpenAPITools.Client.RequestOptions();
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Event> localVarResponse = await InvoiceV1LogIdGetWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Event>> InvoiceV1LogIdGetWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
